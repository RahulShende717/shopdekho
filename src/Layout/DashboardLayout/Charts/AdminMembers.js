...
const AdminMembers=()=>{
    return(
        <>
        <div  style={{backgroundColor:"#efe0ff" ,height:"350px",marginBottom:"10px",paddingTop:"30px",borderRadius:"20px",boxShadow: "rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px"}}>
